STD Guidelines iOS Native Mobile App (Lydia iOS)
===========
This project is a version of the 2014 STD Guidelines built natively for iPhones. 

The current CDC STD Guide available at: http://www.cdc.gov/std/treatment/2010/default.htm

## Goals
To develop and share a useful native iOS app that provides access to the CDC STD Guidelines.
